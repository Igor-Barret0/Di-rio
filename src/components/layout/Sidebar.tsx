        ...
        <div className="shrink-0 border-t border-white/6 pt-2 pb-3 px-2.5">
          {collapsed ? (
            <div className="flex flex-col items-center gap-1">
              <Link
                ...
                className={cn(
                  ...
                  isConfigActive ? "bg-indigo-500/40 text-white" : "text-white/60 hover:text-white/90 hover:bg-white/8",
                )}
              >
              ...
              <a
                ...
                title="Suporte — CVV"
                className="flex items-center justify-center h-10 w-full rounded-xl text-white/60 hover:text-white/90 hover:bg-white/8 transition-all"
              >
            ...
            <div className="space-y-0.5">
              ...
              <button
                onClick={() => setConfirmLogout(true)}
                className="w-full flex items-center gap-3 h-9 px-3 rounded-xl text-sm font-medium text-white/40 hover:text-rose-400 hover:bg-rose-500/8 transition-all"
              >
